...
El workflow describe el proceso del producto desde la orden hasta la entrega. Incluye etapas clave como reserva, validación de datos, generación de envío, registro en el CRM y finalización.
...
* **PULL:** Actualiza el PDF de una etiqueta ya existente en su sistema.

<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>

* **PUSH:** Envía una solicitud para generar una etiqueta nueva.

<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption></figcaption></figure>

* **PULL TRACKING:** Refresca y obtiene el último estado de rastreo de un envío.
...
### Visualización de tracking de mensajería

En esta sección podrá visualizar toda la información relacionada con el envío: **datos del cliente,** **detalles del envío** y el **historial completo de seguimiento.**



<figure><img src="../.gitbook/assets/14-01-2026_10-24-12 (2).gif" alt=""><figcaption></figcaption></figure>
